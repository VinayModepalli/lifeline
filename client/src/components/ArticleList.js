...
class ArticleList extends Component {
    ...
    render() { 
        return ( 
            <div>
                <h1 className="make-center">Articles</h1>
                <div className="container">
                <p><Link to="/">Go Back</Link></p>
                    <div className="row">
                        <div className="col">
                            <Card title={this.state.title[0]} img={this.state.img[0]} excerpt={this.state.excerpt[0]}  post_id={0} />
                        </div>
                        <div className="col">
                            <Card title={this.state.title[1]} img={this.state.img[1]} excerpt={this.state.excerpt[1]}  post_id={1} />
                        </div>
                        <div className="col">
                            <Card title={this.state.title[2]} img={this.state.img[2]} excerpt={this.state.excerpt[2]}  post_id={2} />
                        </div>
                    </div>
                    <div className="row">
                        
                        <div className="col">
                            <Card title={this.state.title[3]} img={this.state.img[3]} excerpt={this.state.excerpt[3]}  post_id={3} />
                        </div>
                    </div>
                </div>
            </div>
